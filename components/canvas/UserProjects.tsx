...
//                 data: { projectId }, // Send projectId as data in the request body
//             });
...
//                     <button className="btn btn-danger">Delete Project</button> {/* Your trigger button */}
//                     </AlertDialogTrigger>
//                     <AlertDialogContent>
//                     <AlertDialogHeader>
...
//                             tags={project.tags}
//                             onDelete={() => deleteProject(project.id)}  // Pass the delete function
//                         />
//                     ))
//                 ) : (
